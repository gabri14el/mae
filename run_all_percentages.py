...
main_dir = 'output_percentages'
os.chdir('/home/gabriel/Projects/mae')
sys.path.append('/home/gabriel/Projects/mae')
dataset_dir = '/home/gabriel/Downloads/castas-huge2-split_percent/'

for m, model in enumerate(maes):
    for p in percentages:
        data = os.path.join(dataset_dir, f'{p}-percent')
        command = f"""/home/gabriel/anaconda3/envs/pytorch/bin/python main_finetune.py \
            --batch_size 80 \
            --model vit_base_patch16  \
            --experiment_name percentages \
            --finetune {model} \
            --epochs 100 \
            --blr 1e-3 --layer_decay 0.65 \
            --weight_decay 0.05 --drop_path 0.1 --reprob 0.25 --mixup 0.8 --cutmix 1.0 \
            --warmup_epochs 10 --dist_eval --data_path {data} \
            --output_dir /home/gabriel/Projects/mae/{main_dir}/ft/{aliases[m]}/{p} \
            --nb_classes 43 --num_workers 1 --log /home/gabriel/Projects/mae/{main_dir}/ft/{aliases[m]}/{p}"""
